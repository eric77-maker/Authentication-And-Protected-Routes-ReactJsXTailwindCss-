...
export async function action({ request }){
    try{
        ...
        const deposite = formData.get('deposite');
        ...
        console.log({ firstName, middleName, lastName, username, deposite, type, email, dateOfBirth, password, confirmPassword });
        ...
        <div className="grow pt-5 flex flex-col">
            <Form method="post" replace className="grow flex pt-5 justify-center">
                <div className="flex flex-col items-center px-2 space-y-3 w-[min(35vw,100%)] min-w-[190px]">
                    <p className="fadeIn text-[11px] sm:text-[min(12px,2.4vh)] scale-x-[110%] sm:scale-x-[100%] sm:text-[max(10px,2vh)] w-[100%] whitespace-nowrap flex justify-center py-1 shadow-sm  rounded items-center text-white">
                    ...
                    <div className="fadeInTwo flex flex-col w-[100%] formInnerContainer rounded items-between justify-center text-white">
                        ...
                        <div className="relative text-white flex flex-col rounded items-center w-[100%] h-[38vh]">
                            ...
                            <div style={page == 3 ?  {opacity: '1', zIndex: '3'} : {opacity: '0', zIndex: '1'}} className="absolute top-2 left-0 w-[100%] flex flex-col space-y-2">
                                <div className="w-[100%] flex flex-col space-y-1 items-center">
                                    <label htmlFor="type" className="rALabel text-slate-300 text-[min(14px,2vh)]">Type</label>
                                    <select className="lAInP text-[min(14px,2vh)] py-[min(0.5vh,2px)] text-slate-800 bg-slate-400" ref={typeInputRef} name="type">
                                        <option value="savings">savings</option>
                                    </select>
                                </div>
                                <div className="w-[100%] flex flex-col space-y-1 items-center">
                                    <label htmlFor="deposite" className="rALabel text-slate-300 text-[min(14px,2vh)]">Deposite</label>
                                    <input className="lAInP text-[min(14px,2vh)] py-[min(0.5vh,2px)] text-slate-800 bg-slate-400" type="text" name="deposite" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="w-[100%] flex flex-col justify-between items-center px-1 py-2 rounded mx-auto grow">
                            ...
                            <div className="rALabel">
                                <div className="w-[100%] mx-auto flex justify-between mt-10">
                                    ...
                                    {page > 2 && 
                                        <button className="btnFadeIn regBtn text-[min(14px,2vh)] bg-blue-800 text-white rounded">Register</button>
                                    }
                                </div>
