...
export default function CustomerDepositePage(){
    ...
    return(
        <>
            ...
            <Form method="post" className="flex flex-col text-[9px] sm:text-[min(11px,2.2vh)] mt-5 space-y-1 items-center">
                ...
                <button className="fadeUp border-none bg-indigo-600 hover:bg-indigo-600/80 cursor-pointer transition py-[0.15vh] text-blue-100 rounded w-[max(25vw,45%)] min-w-[145px]">deposit</button>
            </Form>
